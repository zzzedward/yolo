...
class Mlp(nn.Module):
    def __init__(
        self, in_features, hidden_features=None, out_features=None, act_layer=nn.GELU, drop=0.0, channel_first=False
    ):
        super().__init__()
...
class SS2Dv0:
    ...
    def forwardv0(self, x: torch.Tensor, seq=False, force_fp32=True, **kwargs):
        ...
        K, _D, R = self.dt_projs_weight.shape
        L = H * W
...
class SS2Dv2:
    def __initv2__(
        ...
        **kwargs,
        ...
        self.dt_projs = Linear(
            self.dt_rank, self.k_group * self.d_inner, groups=self.k_group, bias=False, channel_first=True
        )
    ...
    def forward_corev2(
        ...
        **kwargs,
        ...
        B, D, H, W = x.shape
        N = self.d_state
        K, _D, R = self.k_group, self.d_inner, self.dt_rank
        L = H * W
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.patch_embed = self._make_patch_embed(
            in_chans, dims[0], patch_size, patch_norm, channel_first=self.channel_first, version=patchembed_version
        )
